...
Kiro has access to specialized subagents for complex tasks. Use the `#subagents-guide` steering file for detailed guidance.

### Available Subagents
- **yeko-code-reviewer**: Code quality, security, and architecture compliance
- **yeko-frontend-developer**: React components, UI/UX, mobile-first design
- **yeko-fullstack-developer**: End-to-end feature development
- **yeko-test-automator**: Test strategy, automation, and quality assurance
- **yeko-database-specialist**: Schema design, query optimization, data modeling
- **yeko-security-auditor**: Security assessment, compliance, vulnerability testing
- **yeko-performance-engineer**: Performance optimization, bundle analysis, network efficiency

### When to Use Subagents
- **Complex Features**: Use specialized subagents for their domain expertise
- **Quality Gates**: Use review subagents before merging or deploying
- **Performance Issues**: Use performance subagent for optimization
- **Security Concerns**: Use security subagent for auditing
- **Database Design**: Use database subagent for schema and query work
...
| subagents-guide.md | Manual (#subagents-guide) | Using specialized subagents |
