...
export function getSchoolYearById(
  schoolYearId: string,
  schoolId: string,
): ResultAsync<typeof schoolYears.$inferSelect | null, DatabaseError> {
  if (!schoolId) {
    return errAsync(new DatabaseError('VALIDATION_ERROR', SCHOOL_ERRORS.NO_SCHOOL_CONTEXT))
  }
...
export function getActiveSchoolYear(schoolId: string): ResultAsync<typeof schoolYears.$inferSelect | null, DatabaseError> {
  if (!schoolId) {
    return errAsync(new DatabaseError('VALIDATION_ERROR', SCHOOL_ERRORS.NO_SCHOOL_CONTEXT))
  }
...
export function deleteSchoolYear(schoolYearId: string, schoolId: string): ResultAsync<{ success: boolean }, DatabaseError> {
  if (!schoolId) {
    return errAsync(new DatabaseError('VALIDATION_ERROR', SCHOOL_ERRORS.NO_SCHOOL_CONTEXT))
  }
