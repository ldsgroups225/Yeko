...
import { boolean, index, integer, jsonb, pgTable, smallint, text, timestamp, unique } from 'drizzle-orm/pg-core'
...
export const supportTicketPriorities = ['low', 'medium', 'high', 'critical'] as const
export type SupportTicketPriority = typeof supportTicketPriorities[number]

export const supportTicketCategories = ['technical', 'feature', 'bug', 'billing', 'account', 'other'] as const
...
export const supportTickets = pgTable('support_tickets', {
  ...
  priority: text('priority', { enum: supportTicketPriorities }).default('medium').notNull(),
  status: text('status', { enum: supportTicketStatuses }).default('open').notNull(),
  ...
  schoolStatusIdx: index('idx_support_tickets_school_status').on(table.schoolId, table.status),
}))
...
export const contactRoles = ['director', 'admin', 'teacher', 'parent', 'staff', 'other'] as const
...
export const activityTypes = ['call', 'email', 'meeting', 'note', 'ticket', 'other'] as const
