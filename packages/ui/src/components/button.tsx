...
function Button({ ref, className, variant = 'default', size = 'default', isLoading, children, ...props }: ButtonPrimitive.Props & VariantProps<typeof buttonVariants> & { ref?: React.Ref<HTMLButtonElement>, isLoading?: boolean }) {
  return (
    <ButtonPrimitive
      ref={ref}
      data-slot="button"
