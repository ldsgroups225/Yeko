...
export const getOrCreateSession = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { getOrCreateAttendanceSession } = await import('@repo/data-ops/queries/student-attendance')
...
export const saveAttendance = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { saveStudentAttendance } = await import('@repo/data-ops/queries/student-attendance')
...
export const saveBulkAttendance = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { bulkSaveAttendance } = await import('@repo/data-ops/queries/student-attendance')
...
export const getAttendanceStats = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { getClassAttendanceStats } = await import('@repo/data-ops/queries/student-attendance')
...
export const getStudentAttendanceHistory = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { getStudentAttendanceHistory: fetchHistory } = await import('@repo/data-ops/queries/student-attendance')
...
export const getStudentAttendanceTrend = createServerFn()
  ...
  .handler(async ({ data }) => {
    const { getStudentAttendanceTrend: fetchTrend } = await import('@repo/data-ops/queries/student-attendance')
