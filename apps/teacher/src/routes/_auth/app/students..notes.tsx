...
import { IconPlus, IconAlertTriangle, IconInfo, IconCheck } from '@tabler/icons-react'
...
import { studentNotesQueryOptions, behaviorSummaryQueryOptions } from '@/lib/queries/student-notes'
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {note.type === 'academic' && (
                        <Badge variant="secondary">
                          <IconInfo className="w-3 h-3 mr-1" />
