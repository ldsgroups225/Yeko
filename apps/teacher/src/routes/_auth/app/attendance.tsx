          ...
          {counts && (
            <div className="flex gap-2 flex-wrap">
              <Badge variant="secondary">
                {t("attendance.total", "Total")}:{counts.total}
              </Badge>
              <Badge className="bg-green-100 text-green-800">
                {t("attendance.present", "Présents")}:{counts.present}
              </Badge>
              <Badge className="bg-red-100 text-red-800">
                {t("attendance.absent", "Absents")}:{counts.absent}
              </Badge>
              <Badge className="bg-yellow-100 text-yellow-800">
                {t("attendance.late", "Retards")}:{counts.late}
              </Badge>
            </div>
          )}
        </CardContent>
