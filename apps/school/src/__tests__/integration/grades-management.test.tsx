...
const { GradeStatusBadge } = await import('@/components/grades/grade-status-badge')
const { GradeTypeSelector } = await import('@/components/grades/grade-type-selector')
const { GradeStatisticsCard } = await import('@/components/grades/grade-statistics-card')
...
describe('grades Management Integration', () => {
  ...
  describe('grade IconTypography Selector', () => {
    ...
    test('should be disabled when disabled prop is true', () => {
      ...
      render(<GradeTypeSelector value="test" onValueChange={onValueChange} disabled />)
  ...
  describe('grade Statistics Card', () => {
    ...
    test('should render statistics card', () => {
      const { container } = render(<GradeStatisticsCard statistics={mockStatistics} />)
    ...
    test('should accept custom className', () => {
      const { container } = render(
        <GradeStatisticsCard statistics={mockStatistics} className="custom-class" />,
      )
