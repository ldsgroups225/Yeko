...
const { ConductSeverityBadge } =
  await import("@/components/conduct/conduct-severity-badge");
const { ConductStatusBadge } =
  await import("@/components/conduct/conduct-status-badge");
const { ConductTypeBadge } =
...
describe("school Life Management Integration", () => {
  describe("conduct Severity Badge", () => {
    ...
    test("should accept custom className", () => {
      const { container } = render(
        <ConductSeverityBadge severity="high" className="custom-class" />,
      );
    ...
    test("should hide icon when showIcon is false", () => {
      const { container } = render(
        <ConductSeverityBadge severity="low" showIcon={false} />,
      );
  ...
  describe("conduct Status Badge", () => {
    ...
    test("should accept custom className", () => {
      const { container } = render(
        <ConductStatusBadge status="open" className="custom-class" />,
      );
      const badge = container.querySelector('[data-slot="badge"]');
      expect(badge?.className).toContain("custom-class");
    });
  ...
  describe("conduct Type Badge", () => {
    ...
    test("should accept custom className", () => {
      const { container } = render(
        <ConductTypeBadge type="incident" className="custom-class" />,
      );
      const badge = container.querySelector('[data-slot="badge"]');
      expect(badge?.className).toContain("custom-class");
    });
  ...
  describe("teacher Attendance Status Badge", () => {
    test("should display all teacher attendance statuses correctly", () => {
      const { rerender } = render(
        <TeacherAttendanceStatusBadge status="present" />,
      );
    ...
    test("should hide icon when showIcon is false", () => {
      const { container } = render(
        <TeacherAttendanceStatusBadge status="present" showIcon={false} />,
      );
      const svg = container.querySelector("svg");
      expect(svg).not.toBeInTheDocument();
    });
