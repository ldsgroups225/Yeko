import { IconAlertTriangle, IconArrowLeft, IconChartBar, IconChartPie, IconFilter, IconShieldCheck, IconTrendingUp, IconTrophy } from '@tabler/icons-react'
...
import { RecentConductRecords } from '@/components/conduct/recent-conduct-records'
        ...
        {isPending
          ...
          : (
              ...
              >
                ...
                <motion.div variants={item}>
                  <RecentConductRecords records={rawRecords} />
                </motion.div>
              </motion.div>
            )}
      </AnimatePresence>
