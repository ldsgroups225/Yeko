...
export const Route = createFileRoute('/_auth/app/school-life/student-attendance/')({
    ...
    <div className="container py-6">
      <div className="mb-6 flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link to="/app/school-life/student-attendance/history">
            <Button variant="outline" size="sm">
              <Calendar className="mr-2 h-4 w-4" />
              {t('attendance.history')}
            </Button>
          </Link>
          <Link to="/app/school-life/student-attendance/statistics">
            <Button variant="outline" size="sm">
