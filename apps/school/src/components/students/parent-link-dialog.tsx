              ...
              <RadioGroup value={selectedParentId || ''} onValueChange={setSelectedParentId}>
                <div className="space-y-2">
                  {parentsData.data.map((parent: any) => (
                    <div key={parent.id} className="flex items-center space-x-3 rounded-lg border p-3">
