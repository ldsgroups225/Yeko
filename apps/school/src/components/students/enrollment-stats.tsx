...
export function EnrollmentStats() {
  ...
  if (!schoolYearId) {
    return (
      <div className="
        border-border/40 bg-card/30 flex min-h-[200px] items-center
      ...
      <div className="space-y-4">
        ...
        >
          {Array.from({ length: 4 }).map(() => (
            <Card
              key={generateUUID()}
              className="border-border/40 bg-card/50 shadow-sm backdrop-blur-xl"
            >
  ...
  if (error) {
    return (
      <div className="
        border-border/40 bg-card/30 flex min-h-[200px] flex-col items-center
        justify-center rounded-xl border border-dashed p-8 text-center
      "
      >
        <IconUserX className="text-muted-foreground h-12 w-12" />
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <StatCard
          ...
          icon={(
            <IconChartBar className="text-success h-4 w-4" />
          )}
        />
        <StatCard
          ...
          icon={(
            <IconLoader2 className="text-accent-foreground h-4 w-4" />
          )}
        />
        <StatCard
          ...
          icon={(
            <IconUsers className="text-secondary h-4 w-4" />
          )}
        />
      </div>
      <div className="
