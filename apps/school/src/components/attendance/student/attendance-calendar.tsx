      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-7 gap-2 text-center mb-4">
          {(locale === "fr"
            ...
            <div
              key={generateUUID()}
              className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/30"
            >
              {day}
            </div>
          ))}
        ...
        <div className="grid grid-cols-7 gap-2">
          <AnimatePresence mode="popLayout">
            {calendarDays.map((day, idx) => {
              if (!day) {
                return (
                  <div key={generateUUID()} className="h-12 rounded-2xl" />
                );
              }
                          ...
                          className={cn(
                            ...
                            config
                              ? cn(
                                  config.bgColor,
                                  config.borderColor,
                                  "shadow-lg shadow-black/5 scale-[1.02] z-10",
                                )
