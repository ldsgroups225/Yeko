      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="font-medium">
            {row.original.grade.name} {row.original.series?.name}{" "}
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex items-center gap-1">
            ...
            <span>
              {row.original.studentsCount} /{row.original.class.maxStudents}
            </span>
          </div>
        ),
      },
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <p className="font-medium text-foreground">
                        {item.grade.name} {item.series?.name}{" "}
                        <span className="text-muted-foreground">
                          {item.class.section}
                        </span>
                      </p>
      ...
      {hasResults && table.getPageCount() > 1 && (
        <div className="flex items-center justify-center gap-2 mt-4">
          ...
          <span className="text-sm text-muted-foreground">
            {t.common.showing()} {table.getState().pagination.pageIndex + 1}{" "}
