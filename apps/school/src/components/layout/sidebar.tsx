import { IconAlertTriangle, IconBell, IconBook, IconBuilding, IconCalendar, IconChartBar, IconChevronDown, IconClipboardCheck, IconCreditCard, IconCurrencyDollar, IconFileSearch, IconFileText, IconLayoutDashboard, IconLayoutGrid, IconPercentage, IconReportAnalytics, IconRotate, IconSchool, IconSettings, IconShieldCheck, IconUserCheck, IconUsers, IconUsersGroup, IconWallet } from '@tabler/icons-react'
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const navigationItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: IconSchool,
      children: [
        { title: t.nav.studentsList(), href: '/students', icon: IconSchool },
        { title: t.nav.parents(), href: '/students/parents', icon: IconUsers },
        { title: t.nav.enrollments(), href: '/students/enrollments', icon: IconClipboardCheck },
        { title: t.students.bulkOperations.title(), href: '/students/bulk-operations', icon: IconFileText },
      ],
    },
    {
      title: t.nav.classes(),
      ...
      icon: IconBook,
      children: [
        { title: t.nav.classes(), href: '/classes', icon: IconBook },
        { title: t.nav.assignments(), href: '/classes/assignments', icon: IconUsers },
      ],
    },
    {
      title: t.nav.users(),
      ...
      icon: IconUsers,
      children: [
        { title: t.nav.users(), href: '/users/users', icon: IconUsersGroup },
        { title: t.nav.staff(), href: '/users/staff', icon: IconUserCheck },
        { title: t.nav.teachers(), href: '/users/teachers', icon: IconSchool },
        { title: t.nav.roles(), href: '/users/roles', icon: IconShieldCheck },
      ],
    },
    ...
    // ACADEMIC OPERATIONS (Middle)
    {
      ...
      children: [
        { title: t.nav.grades(), href: '/grades/entry', icon: IconFileText },
        { title: t.common.view(), href: '/grades', icon: IconFileSearch },
        { title: t.grades.statistics.title(), href: '/grades/statistics', icon: IconChartBar },
        { title: t.grades.validations.title(), href: '/grades/validations', icon: IconClipboardCheck },
        { title: t.nav.reportCards(), href: '/grades/report-cards', icon: IconReportAnalytics },
      ],
    },
    {
      ...
      children: [
        { title: t.schoolLife.studentAttendance(), href: '/conducts/student-attendance', icon: IconUserCheck },
        { title: t.schoolLife.teacherAttendance(), href: '/conducts/teacher-attendance', icon: IconUserCheck },
        { title: t.nav.conduct(), href: '/conducts/conduct', icon: IconAlertTriangle },
        { title: t.nav.punctuality(), href: '/conducts/alerts', icon: IconBell },
        { title: t.conduct.reports(), href: '/conducts/conduct/reports', icon: IconReportAnalytics },
        { title: t.common.settings(), href: '/conducts/settings', icon: IconSettings },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: IconBook,
      children: [
        { title: t.nav.subjects(), href: '/programs/subjects', icon: IconBook },
        { title: t.nav.coefficients(), href: '/programs/coefficients', icon: IconPercentage },
        { title: t.nav.curriculumProgress(), href: '/programs/curriculum-progress', icon: IconLayoutGrid },
      ],
    },
    ...
    // ADMINISTRATIVE (Lower)
    {
      ...
      children: [
        { title: t.nav.dashboard(), href: '/accounting/dashboard', icon: IconLayoutDashboard },
        { title: t.finance.feeTypes.title(), href: '/accounting/fee-types', icon: IconFileText },
        { title: t.finance.feeStructures.title(), href: '/accounting/fee-structures', icon: IconLayoutGrid },
        { title: t.finance.studentFees.title(), href: '/accounting/student-fees', icon: IconUsers },
        { title: t.nav.payments(), href: '/accounting/payments', icon: IconCreditCard },
        { title: t.finance.paymentPlans.title(), href: '/accounting/payment-plans', icon: IconCalendar },
        { title: t.finance.discounts.title(), href: '/accounting/discounts', icon: IconPercentage },
        { title: t.finance.refunds.title(), href: '/accounting/refunds', icon: IconRotate },
        { title: t.finance.accounts.title(), href: '/accounting/accounts', icon: IconWallet },
      ],
    },
    {
      title: t.nav.spaces(),
      ...
      icon: IconBuilding,
      children: [
        { title: t.nav.classrooms(), href: '/spaces/classrooms', icon: IconBuilding },
        { title: t.common.view(), href: '/spaces/availability', icon: IconCalendar },
      ],
    },
    ...
    // CONFIGURATION (Bottom - Least Frequent)
    {
      ...
      icon: IconSettings,
      children: [
        { title: t.sidebar.schoolName(), href: '/settings/profile', icon: IconBuilding },
        { title: t.nav.schoolYears(), href: '/settings/school-years', icon: IconCalendar },
        { title: t.nav.reportCardTemplates(), href: '/settings/report-cards', icon: IconFileText },
        { title: t.common.notifications(), href: '/settings/notifications', icon: IconBell },
      ],
    },
  ]
              ...
              {navigationItems.slice(0, 4).map(item => (
                <SidebarMenuItem key={item.href}>
                  {item.children
                    ...
                    : (
                        <SidebarMenuButton
                          render={<Link to={item.href} className="flex w-full items-center gap-3" />}
              ...
              {navigationItems.slice(4, 8).map(item => (
                <SidebarMenuItem key={item.href}>
                  {item.children
                    ...
                    : (
                        <SidebarMenuButton
                          render={<Link to={item.href} className="flex w-full items-center gap-2 py-2" />}
                          isActive={pathname === item.href}
                          tooltip={item.title}
...
function SidebarMenuSubItemWrapper({
  ...
  // IconCheck if any child is active to highlight the parent
