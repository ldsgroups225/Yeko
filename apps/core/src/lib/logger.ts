  ...
  if (!isInitialized || !isReady) {
    return {
      logger: {
        ...
        performance: () => { },
        security: () => { },
        withContext: () => ({} as unknown as YekoLogger),
        withUser: () => ({} as unknown as YekoLogger),
        withSchool: () => ({} as unknown as YekoLogger),
        withAcademicContext: () => ({} as unknown as YekoLogger),
        child: () => ({} as unknown as YekoLogger),
      },
      userLogger: {
        logAction: () => { },
        logNavigation: () => { },
        logError: () => { },
        logFormSubmission: () => { },
        withUser: () => ({} as unknown as UserInteractionLogger),
      },
      logUserAction: () => { },
      logNavigation: () => { },
      logError: () => { },
