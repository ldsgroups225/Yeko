...
import { deleteUser, updateUser } from '@repo/data-ops/queries/school-admin/users'
import { createServerFn } from '@tanstack/react-start'
import { protectedFunctionMiddleware } from '@/core/middleware/auth'
import { suspendUserSchema, removeUserSchema } from '@/schemas/user'
...
export const suspendUser = createServerFn()
  ...
  .handler(async ({ data }) => {
    try {
      ...
      throw new Error(error.message || 'Erreur lors de la suspension de l\'utilisateur')
    }
  })
